...
// the format used internally to vixal-core.
//
// vixal-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, horizon, the client-libraries and other built
// on top of vixal-core use a convention, encoding amounts as a string of
...
// represented in vixal-core as 1010010000.
package amount
...
// Parse parses the provided as a vixal "amount", i.e. A 64-bit signed integer
