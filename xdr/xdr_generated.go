...
// VixalValueExt is an XDR NestedUnion defines as:
//
//   union switch (int v) {
//        case 0:
//            void;
//        }
//
type VixalValueExt struct {
	V int32
}

// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u VixalValueExt) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of VixalValueExt
func (u VixalValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch int32(sw) {
	case 0:
		return "", true
	}
...
// NewVixalValueExt creates a new  VixalValueExt.
func NewVixalValueExt(v int32, value interface{}) (result VixalValueExt, err error) {
	result.V = v
	switch int32(v) {
	case 0:
		// void
...
// VixalValue is an XDR Struct defines as:
//
//   struct VixalValue {
...
// VixalMessage is an XDR Union defines as:
//
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u VixalMessage) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of VixalMessage
func (u VixalMessage) ArmForSwitch(sw int32) (string, bool) {
...
// NewVixalMessage creates a new  VixalMessage.
func NewVixalMessage(aType MessageType, value interface{}) (result VixalMessage, err error) {
	result.Type = aType
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// returning ok if the union's switch indicated the value is valid.
func (u VixalMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
