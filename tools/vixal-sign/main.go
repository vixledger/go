// vixal-sign is a small interactive utility to help you contribute a
...
import (
	...
	"github.com/vixledger/go/builder"
...
func main() {
	...
	b := &builder.TransactionEnvelopeBuilder{E: &txe}
	b.Init()
	b.MutateTX(builder.PublicNetwork)
	b.Mutate(builder.Sign{seed})
	if b.Err != nil {
		log.Fatal(b.Err)
	}
